...
for file in files:
    ...
    for row in range(len(read)):
        ...
        pval = read['Pr(>|t|)'][row] # Pull p value of greenness metric from model
...
modelsdf = modelsdf[['term', 'Participant_20m_Mean_ndvi', 'Participant_50m_Mean_ndvi', 'Participant_100m_Mean_ndvi',
                         'Participant_150m_Mean_ndvi', 'Participant_200m_Mean_ndvi',
                         'Participant_300m_Mean_ndvi', 'Participant_500m_Mean_ndvi',
                         "Parcel_ndvi_Mean", "Nobuilding_ndvi_Mean", "morevisible_ndvi_MEAN", "lessvisible_ndvi_MEAN",
                         ...
                         "Parcel_ndvi_Sum", "Nobuilding_ndvi_Sum", "Participant_20m_Mean_NDVI_L19",
                     ...
                     "Participant_300m_Mean_NDVI_L19", "Participant_500m_Mean_NDVI_L19", "Parcel_NDVI_L19_Mean",
